export AWS_PROFILE=s3-cloud-apps

docker rm -f master-mysql

mvn package -DskipTests

export BUCKET_NAME=practica-1-prueba.cloud.michel
export REGION=us-east-1

docker run --name master-mysql -p 3306:3306 -e MYSQL_ROOT_PASSWORD=cloud-computing -e MYSQL_DATABASE=events_db -d  mysql:8.0
sleep 10
