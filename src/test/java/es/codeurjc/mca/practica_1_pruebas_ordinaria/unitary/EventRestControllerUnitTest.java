...
import es.codeurjc.mca.events.DatabaseInitializer;
...
public class EventRestControllerUnitTest {
	...
	public void createEventTest() throws Exception {
        ...
        User organizer = new User("Patxi", "francisco.gortazar@urjc.es", "pass", User.ROLE_ORGANIZER);

        when(eventRepository.save(any(Event.class))).thenReturn(event1);
        when(userService.getMe()).thenReturn(organizer);
