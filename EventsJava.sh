...
export RDS_ENDPOINT=michel-p1-events.c8opnni6gu6v.us-east-1.rds.amazonaws.com
...
case $1 in 
     ...
     if [ ! -f $PID_PATH_NAME ]; then 
          nohup java -jar -Dspring.profiles.active=production $PATH_TO_JAR --server.port=8443 &      
          echo $! > $PID_PATH_NAME  
